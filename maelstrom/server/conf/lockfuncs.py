...
def cg_one_done(accessing_obj, accessed_obj, *args, **kwargs):
    required_attributes = [
        'first_name',
        'last_name',
        'gender',
    ...
    for attr in required_attributes:
        if not accessing_obj.attributes.get(attr, default=None):
            accessing_obj.msg('Must SET all required attributes before '
                              'continuing on. Use NEXT when finished.')
            return False
    return True
